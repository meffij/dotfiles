...
# export LYNX_LSS=~/.config/lynx.lss

# Mount the portable Documents folder, if it isn't already
# if (("$PORTABLEAPPS" == "true") && [ ! -d Documents ]);
# 	then mount -f "$USBDRV\Documents" "/home/$USERNAME/Documents";
# fi
...
#alias subl='cyg-wrapper.sh "$USBDRV/PortableApps/SublimeText2Portable/sublime_text.exe" --fork=2'
